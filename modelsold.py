...
class Fixer(Base):
    ...
    langue_preferee = Column(String(10), default='EN')
...
class Reperage(Base):
    ...
    # 3. GUARDIANS (3x10)
    g1_nom_prenom = Column(String(255)); g1_age = Column(String(50)); g1_fonction = Column(String(255)); g1_savoir = Column(Text); g1_histoire = Column(Text); g1_psychologie = Column(Text); g1_evaluation = Column(Text); g1_langues = Column(String(255)); g1_contact = Column(Text); g1_intermediaire = Column(Text)
    g2_nom_prenom = Column(String(255)); g2_age = Column(String(50)); g2_fonction = Column(String(255)); g2_savoir = Column(Text); g2_histoire = Column(Text); g2_psychologie = Column(Text); g2_evaluation = Column(Text); g2_langues = Column(String(255)); g2_contact = Column(Text); g2_intermediaire = Column(Text)
    g3_nom_prenom = Column(String(255)); g3_age = Column(String(50)); g3_fonction = Column(String(255)); g3_savoir = Column(Text); g3_histoire = Column(Text); g3_psychologie = Column(Text); g3_evaluation = Column(Text); g3_langues = Column(String(255)); g3_contact = Column(Text); g3_intermediaire = Column(Text)

    # 4. LOCATIONS (3x15)
    l1_nom = Column(String(255)); l1_type = Column(String(255)); l1_description = Column(Text); l1_cinegenie = Column(Text); l1_axes = Column(Text); l1_points_vue = Column(Text); l1_moments = Column(Text); l1_son = Column(Text); l1_adequation = Column(Text); l1_acces = Column(Text); l1_securite = Column(Text); l1_elec = Column(Text); l1_espace = Column(Text); l1_meteo = Column(Text); l1_permis = Column(Text)
    l2_nom = Column(String(255)); l2_type = Column(String(255)); l2_description = Column(Text); l2_cinegenie = Column(Text); l2_axes = Column(Text); l2_points_vue = Column(Text); l2_moments = Column(Text); l2_son = Column(Text); l2_adequation = Column(Text); l2_acces = Column(Text); l2_securite = Column(Text); l2_elec = Column(Text); l2_espace = Column(Text); l2_meteo = Column(Text); l2_permis = Column(Text)
    l3_nom = Column(String(255)); l3_type = Column(String(255)); l3_description = Column(Text); l3_cinegenie = Column(Text); l3_axes = Column(Text); l3_points_vue = Column(Text); l3_moments = Column(Text); l3_son = Column(Text); l3_adequation = Column(Text); l3_acces = Column(Text); l3_securite = Column(Text); l3_elec = Column(Text); l3_espace = Column(Text); l3_meteo = Column(Text); l3_permis = Column(Text)

    # 5. FESTIVITY
    fete_lieu_date = Column(String(255))
    fete_pourquoi = Column(Text)
...
class Media(Base):
    ...
    id = Column(Integer, primary_key=True); reperage_id = Column(Integer, ForeignKey('reperages.id')); type = Column(String(50)); nom_fichier = Column(String(255)); nom_original = Column(String(255)); chemin_fichier = Column(String(500)); uploaded_at = Column(DateTime, default=datetime.now)
...
class Message(Base):
    ...
    id = Column(Integer, primary_key=True); reperage_id = Column(Integer, ForeignKey('reperages.id')); auteur_type = Column(String(20)); auteur_nom = Column(String(255)); contenu = Column(Text); created_at = Column(DateTime, default=datetime.now); lu = Column(Boolean, default=False)
    def to_dict(self): return {c.name: getattr(self, c.name).isoformat() if isinstance(getattr(self, c.name), datetime) else getattr(self, c.name) for c in self.__table__.columns}
